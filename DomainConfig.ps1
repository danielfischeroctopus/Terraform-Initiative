...
<#
New-Item -Path C:\ -Name "NewOU.ps1" -ItemType "file" -Value "New-AdOrganizationalUnit -Name 'Joined Servers' -Path 'DC=TFI,DC=LOCAL' -ProtectedFromAccidentalDeletion 'true'"
