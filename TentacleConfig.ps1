...
# Run PowerShell script under a new user & Install Tentacle
# make var
...
Invoke-Command -Authentication CredSSP -ScriptBlock {choco install octopusdeploy.tentacle -y} -ComputerName azure-vm -Credential $credential
